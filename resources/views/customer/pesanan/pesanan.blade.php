                                                ...
                                                @if ($data->tipe_pembayaran == 'dp')
                                                    @if ($data->dp_status == 'dp')
                                                        ...
                                                        @elseif ($data->status == '1')
                                                            <span class="badge bg-primary">Pembayaran Sedang Di
                                                                Tinjau</span>
                                                        @else
                                                            <span class="badge bg-success">Pesanan Anda Sedang Di
                                                                Buat</span>
                                                        @endif
                                                    ...
                                                    @elseif ($data->dp_status == 'upload_lunas')
                                                        <span class="badge bg-success">Sisa Pembayaran Telah Di
                                                            Upload</span>
                                            ...
                                            <td>
                                                @if ($data->tipe_pembayaran == 'dp')
                                                    ...
                                                    @elseif ($data->dp_status == 'sisa tolak')
                                                        <button type="button" class="btn btn-de-primary btn-sm"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#exampleModalDefault">Bayar Ulang
                                                            Tagihan</button>
                                                    @elseif ($data->dp_status == 'upload_lunas')
                                                    @endif
                                                @elseif ($data->tipe_pembayaran == 'lunas')
                                                    @php
                                                        if ($data->status == '0') {
                                                            echo '<a href="' .
                                                                route('customer.upload_ulang', $data->id_pesanan) .
                                                                '" style="color:blue"><i class="ti ti-cloud-upload"></i>Upload Ulang</a>';
                                                        } elseif ($data->status == '2') {
                                                            echo '<a href="' .
                                                                route('customer.pesanan_invoice', $data->id_pesanan) .
                                                                '" target="_blank" class="btn btn-sm btn-secondary"><i class="ti ti-file-invoice"> Invoice</i></a>';
                                                        }
                                                    @endphp
                                                @endif
                                                <div class="modal fade" id="exampleModalDefault" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <form action="{{ route('customer.upload_sisa_tagihan') }}"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-3 text-center align-self-center">
                                                                            {{-- <img src="assets/images/small/btc.png"
                                                                                    alt="" class="img-fluid"> --}}
                                                                            <img id="output1"
                                                                                src="/dapuranita/default-produk.png"
                                                                                class="img-fluid">
                                                                        </div>
                                                                        <!--end col-->
                                                                        <div class="col-lg-9">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit"
                                                                        class="btn btn-de-primary btn-sm">Upload
                                                                        Pembayaran</button>
                                                                </div>
                                                            </form>
                                                            <!--end modal-footer-->
