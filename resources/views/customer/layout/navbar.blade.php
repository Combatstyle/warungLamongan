    ...
    <li class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end">
            ...
            <a class="dropdown-item" href="{{ route('alamat.index') }}"><i
                    class="fas fa-address-book font-16 me-1 align-text-bottom"></i> Alamat Anda</a>
        ...
        <ul class="navigation-menu">
            ...
            @php
                ...
                $notif_onpaid = DB::table('pesanan')
                    ...
                    ->where('pesanan.id_user', Auth::user()->id)
                    ->where(function ($query) {
                        $query->where('pesanan.status', 0)->orWhere('pesanan.status', 1)->orWhere('pesanan.status', 2);
                    })
                    ->get();
