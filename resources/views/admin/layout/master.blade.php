...
<head>
    ...
    <!-- App favicon -->
    <title>Warung Lamongan Cak Lutfi</title>
...
<body data-layout="horizontal" class="">
    ...
    <div class="topbar">
        ...
        <div class="brand">
            <a href="index.html" class="logo">
                <span>
                    <img src="/dapuranita/logoLamongan.png" alt="logo-small" height="55" width="55">
                </span>
                <span>
    ...
    <footer class="footer text-center text-sm-start">
        ...
        {{-- | Repost by <a href='https://stokcoding.com/' title='StokCoding.com'
            target='_blank'>StokCoding.com</a> --}}
        <span class="text-muted d-none d-sm-inline-block float-end">Crafted with <i
                class="mdi mdi-heart text-danger"></i> by Cak Lutfi</span>
    </footer>
    <!-- end Footer -->
    <!--end footer-->
