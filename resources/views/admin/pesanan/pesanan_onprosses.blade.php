                                                                        ...
                                                                        @if ($data->tipe_pembayaran == 'lunas')
                                                                            <button class="btn btn-de-success" data-bs-toggle="modal"
                                                                                data-bs-target="#exampleModalSmall{{ $data->id_pesanan }}"><i
                                                                                    class="ti ti-truck-delivery"></i>Pesanan Siap Diambil</button>
                                                                        @else
                                                                                @if ($data->dp_status == 'dp')
                                                                                        <a href="{{ route('admin.pesanan_tagihan', $data->id_pesanan) }}"
                                                                                            class="btn btn-danger"><i class="ti ti-report-money"> Kirim Tagihan</i></a>
                                                                                    </td>
                                                                                ...
                                                                                @elseif ($data->dp_status == 'upload_lunas')
                                                                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                                                        data-bs-target="#SisaModalCenter-{{ $data->id_pesanan }}">Cek Sisa
                                                                                        Pembayaraan</button>
                                                                                    &nbsp;&nbsp;
                                                                                    <a href="{{ route('admin.tolak_sisa', $data->id_pesanan) }}" style="color:red"><i
                                                                                            class="ti ti-circle-x"></i>Tolak</a>
                                                                                    &nbsp;&nbsp;
                                                                                    <a href="#" data-bs-toggle="modal"
                                                                                        data-bs-target="#exampleModalSmall{{ $data->id_pesanan }}"
                                                                                        style="color:green"><i class="ti ti-check"></i>Pesanan Siap Diambil</a>

                                                                                    <div class="modal fade" id="SisaModalCenter-{{ $data->id_pesanan }}" tabindex="-1"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                <form action="{{ route('admin.pesanan_kirim') }}" method="post"
                                                                                    ...
                                                                                    <div class="modal-body text-center">
                                                                                        <div class="mb-0">
                                                                                            ...
                                                                                            <input type="text" name="resi" class="form-control"
                                                                                                id="exampleInputEmail1" placeholder="Nomor Resi"
                                                                                                required>
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        ...
                                                                                        <button type="submit" class="btn btn-de-primary btn-sm">Kirim
                                                                                            Resi</button>
                                                                                    </div>
                                                                                </form>
                                                                                <!--end modal-footer-->
