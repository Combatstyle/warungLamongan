...
<head>
    ...
    <!-- App favicon -->
    <title>Warung Cak Lutfi</title>
    <link rel="shortcut icon" href="/dapuranita/logoLamongan.png">
                                ...
                                <div class="card-body p-0">
                                    <div class="text-center p-3">
                                        <a href="index.html" class="logo logo-admin">
                                            <img src="/dapuranita/logoLamongan.png" height="50" alt="logo"
                                                class="auth-logo">
                                        </a>
                                        <h4 class="mt-3 mb-1 fw-semibold font-18">Selamat Datang Di Warung Lamongan Cak
                                            Lutfi</h4>
                                        <br>
                                        {{-- <center>
                        ...
                        <div class="col-md-7 col-xl-9 col-lg-8  p-0 vh-100 d-flex justify-content-center auth-bg">
                            <div class="accountbg d-flex align-items-center">
                                <div class="account-title text-center text-white">
                                    <h1 class="text-white">Makanan Khas Lamongan</h1>
                                    <p class="font-18 mt-3">Berbagai menu makanan dengan lalapan dan sambal khas
                                        Lamongan</p>
